    ...
    <div>
      ...
      <div className="absolute top-[min(7vw,7rem)] left-[min(2vw,2rem)] w-full">
        <p className="text-gray-600 text-[min(1.2vw,1.2rem)] text-justify">
          AI-KATA S2Pは、ユーザーの描いたオリジナルイラストをAIが解析し、キャラクターを生成する創造力を育むツールです。<br />
          展示バージョンからリリースバージョンへの移行を進め、システム設計・機能改善・料金プラン設計、アカウント管理とStripeを用いたサブスクリプション課金を実装しました。<br />
          また、アプリストア対応（説明文・スクショ作成）や、利用規約・法人向け契約書の作成を担当。<br />
        ...
        <ul className="mt-2 space-y-4">
          ...
          <li className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="ml-[min(1.3vw,1.3rem)] space-y-1 list-disc text-[min(0.9vw,0.9rem)]">
                <li className='marker:text-gray-300'>ソフトウェアのUI設計・デザイン<br/>ユーザーエクスペリエンスの最適化</li>
      ...
      <div className="flex gap-[min(2vw,2rem)]">
          <div className="mt-[min(2vw,2rem)]">
            <img src={image1} alt="" />
            <p className="text-[min(1vw,1rem)] w-[46%]">WEBサイト<br />
              <a href="https://aikatas2p.kidsplates.jp/" target="_blank" rel="noreferrer" className="text-blue-500 underline">https://aikatas2p.kidsplates.jp/</a>
            </p>
          </div>
