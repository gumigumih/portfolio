...
また、展示会のブースデザインやプロモーション活動を通じて、サービスの普及を支援しています。`,
  ...
  achievements: [
    ...
    },
    {
      title: "プレスリリース効果",
      value: "2倍",
      description: "メディアリスト適切選定による効果向上"
    }
  ],
  ...
  timeline: [
    {
      ...
      achievements: [
        { category: "デザイン・制作", text: "キッズ向けUIデザインの開発" },
        { category: "デザイン・制作", text: "展示会用プロモーション資料の制作" },
        { category: "技術開発", text: "展示会ブース用の自動フォローアップメールシステム（GAS）の構築" },
        { category: "運用・改善", text: "展示会用営業資料の作成とブース設営準備" }
      ]
    },
    {
      ...
      achievements: [
        { category: "デザイン・制作", text: "一般ユーザー向けUI/UXデザインの開発" },
        { category: "デザイン・制作", text: "サービス紹介・利用案内サイトのデザイン・制作" },
        { category: "デザイン・制作", text: "アプリストア向けスクリーンショット・アイコン等の制作" },
        { category: "プロダクト戦略", text: "秒数・トークン・文字数など異なる課金単位を統合する独自ポイント制の料金プラン設計" },
        ...
        { category: "技術開発", text: "アプリストア課金システムとの連携実装" },
        { category: "運用・改善", text: "アプリストア審査対応とリリース準備" }
      ]
    }
  ],
