...
また、展示会のブースデザインやプロモーション活動を通じて、サービスの普及を支援しています。`,
  ...
  challenges: {
    issues: [
      {
        title: "展示版からリリース版への移行",
        description: "展示バージョンは機能が限定的でしたが、リリース版では安定した動作と使いやすさを両立させる必要がありました。特に、展示時は口頭説明があることを前提としたUX設計になっていたため、説明なしでも直感的に使えるUIへの改善が大きな課題でした。",
      },
      {
        title: "持続可能なビジネスモデルの確立",
        description: "教育ツールとして適切な料金設定と、Stripeを用いた課金システムの実装が必要でした。特に、秒数・トークン・文字数など異なる課金体系を持つAIサービスを、ユーザーにとって分かりやすい月額制に統一することが大きな課題でした。また、法人向けの契約書作成や利用規約の整備、アプリストア対応など、リリースに向けた法務・運用面での課題も多くありました。",
      }
    ]
  },
  ...
  timeline: [
    ...
    },
    {
      ...
      description: "展示版から商用版への移行と本格サービスリリースに向けた開発を推進しました。",
      achievements: [
        ...
        { category: "実装", text: "ユーザー管理・課金管理システムの開発" }
      ]
    },
    {
      title: "アプリストア展開",
      period: "2024年7月〜2024年10月",
      description: "商用版のアプリストア展開に向けた対応とプラットフォーム連携の実装を行いました。",
      achievements: [
