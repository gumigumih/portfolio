...
export const projects = [
  ...
  { start: { year: 2021, month: 7 }, end: { year: 2022, month: 3 }, text: '', row: 3, jumpTo: 'miuraKamakura' },
  { start: { year: 2022, month: 10 }, end: { year: 2023, month: 2 }, text: '歴史体験コンテンツ活用・バスツアー企画', row: 3, jumpTo: 'miuraKamakura' },
  { start: { year: 2024, month: 1 }, end: { year: 2024, month: 1 }, text: '', row: 3, jumpTo: 'miuraKamakura' },
  { start: { year: 2024, month: 7 }, end: { year: 2025, month: 3 }, text: '新規バスツアー企画・音声ガイド開発', row: 3, jumpTo: 'miuraKamakura' },
  ...
  { start: { year: 2023, month: 2 }, end: { year: 2023, month: 5 }, text: 'TV番組3Dキャラ支援', textClass: 'left-[1rem] tracking-[0.2rem]', row: 2, jumpTo: 'majikaruLove' },
  { start: { year: 2023, month: 12 }, end: { year: 2024, month: 2 }, text: '', row: 2 },
  { start: { year: 2023, month: 4 }, end: { year: 2023, month: 9 }, text: 'アバター個別相談アプリ', textClass: 'right-0', row: 5, jumpTo: 'fukuokaVsapo' },
