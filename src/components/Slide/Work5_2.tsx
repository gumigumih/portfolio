      ...
      <div className='absolute top-[min(3vw,3rem)] left-[min(3vw,3rem)] mr-[min(2vw,2rem)]'>
        ...
        <div className="flex gap-[min(2vw,2rem)]">
          <div className="mt-[min(2vw,2rem)]">
            <img src={image7} alt="" />
            <p className="text-[min(1vw,1rem)]">WEBサイト➀ 三浦一族の物語紹介サイト<br />
              <a href="https://unkeibushido.com/" target="_blank" rel="noreferrer" className="text-blue-500 underline">https://unkeibushido.com/</a>
            </p>
          </div>
          <div className="mt-[min(2vw,2rem)]">
            <img src={image8} alt="" />
            <p className="text-[min(1vw,1rem)]">WEBサイト➁ 現地体験型プログラム紹介サイト<br />
              <a href="https://kamakurabushi.com/" target="_blank" rel="noreferrer" className="text-blue-500 underline">https://kamakurabushi.com/</a>
            </p>
          </div>
          <div className="mt-[min(2vw,2rem)]">
            <img src={image9} alt="" />
            <p className="text-[min(1vw,1rem)]">WEBサイト➂ ＶＲ発願体験紹介サイト<br />
              <a href="https://virtualunkei.com/" target="_blank" rel="noreferrer" className="text-blue-500 underline">https://virtualunkei.com/</a>
            </p>
          </div>
        </div>
      </div>
